...
const Header = () => {
  ...
  const navbarClickHandle = () => {
    navRef.current.colapse();
  }


  return (
    <div className='header-box'>
      <nav className="navbar navbar-expand-lg" onClick={navbarClickHandle}>
        <div className="container-fluid">
            ...
            <div className="collapse navbar-collapse justify-content-end" ref={navRef} id="mainNavbar">
